...
- **4.º quartel:** coroa de espinhos em negro atravessada por três cravos de prata — referência à Paixão e ao amor redentor.
...
- **Linha Old Catholic / Vétero‑Católica:** desenvolveu‑se a partir de consagrações independentes (séculos XIX–XX), com nomes-chave como Mar Ignatius Peter III, Mar Julius I e Joseph René Vilatte, que transmitiram a sucessão para a América e outras regiões.

**Cadeia moderna resumida (integração das fontes):**  
